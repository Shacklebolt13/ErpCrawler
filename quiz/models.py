...
defImg = base64.b64encode(
    open(str(BASE_DIR) + "/quiz/static/quiz/defImg.jpg", "rb").read()
).decode()
...
class Question(models.Model):
    ...
    practiceBranch = models.ForeignKey(
        PracticeQuestions, null=True, on_delete=models.RESTRICT, blank=True
    )
    sponsorship = models.ForeignKey(
        SponsoredQuestions, null=True, on_delete=models.RESTRICT, blank=True
    )
