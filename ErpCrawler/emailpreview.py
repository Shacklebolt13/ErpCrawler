    ...
    <tr>
      <td>
        <table class="content" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#F7F7F7" style="width: 600px; max-width: 600px;">
          <tr>
            <td colspan="2" style="background: rgb(252, 219, 219); border-radius: 8px;">
        ...
        Hi there,
                              ...
                              <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                  <td style="-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;">
                                    <a href="" target="_blank" style="display:inline-block; color: #fff; font-weight: 400; border-left: 15px solid; border-right: 15px solid; border-top: 12px solid; border-bottom: 12px solid; font-size: 17px; text-decoration: none; text-align: center; -webkit-text-size-adjust: none; -webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; background-color: #17366A; border-color: #17366A;"
                                      class="btn">
                        ...
                        <p style="color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; " class="">If you didn&#39;t request a registration, you can ignore this email</p>
                        ...
                        <a href="https://play.google.com/store/apps/details?id=com.gietuportalofficial.gietuofficial">
                          <h3 style="border: 0;" height="38">GIETU OFFICIAL APP TEAM </h3>
        ...
        <table class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="width: 600px; max-width: 600px; font-family: Helvetica, Arial, sans-serif;">
            <tr>
              <td style="padding-top: 5px;">
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td style="background-color: #3d0bf3;  width: 100%; font-size: 1px; height: 1px; line-height: 1px;"><hr></td>
                  </tr>
                </table>
              </td>
            </tr>
            ...
            <tr>
              <td class="grid__col" style="font-family: 'Helvetica neue', Helvetica, arial, sans-serif; padding: 5px 0; text-align: center;">
                <table cellspacing="0" cellpadding="0" width='100%' align='' class="col-layout"  style="background-color: #f8f4f4;">
                  <tr>
                    <td width='auto' height='auto' align='center'
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%" >
                           ...
                           <a href="https://play.google.com/store/apps/details?id=com.gietuportalofficial.gietuofficial">
                               <center><img src="http://www.gandhionline.in/BEESERP/Images/header.jpg" width="500" height="50" border="0" alt="Eventbrite" style="width:auto; height:100px;" valign="middle" align="center" /></center>
                           </a>
                      </table>
                    </td>
                  </tr>
            ...
            <tr>
              <td>
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td style="background-color: #f70857;  width: 100%; font-size: 1px; height: 1px; line-height: 1px;"><hr></td>
                  </tr>
                </table>
              </td>
            </tr>
